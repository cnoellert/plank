...
| Live Sunshine/Moonlight identity session | Functional pass; pacing gate pending | The NUC negotiated format `0x800`, hardware-decoded to Y410, imported the Y410/XR30 alias through EGL, and sustained approximately 60 fps. Two full-loop runs had no network loss but each reported 0.04% client pacer drops. |
