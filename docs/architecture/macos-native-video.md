...
`apps/host/macos/media/native-video.m` accepts one ready HEVC sample with exact
...
`scripts/test/build-macos-native-video.sh` builds with SDK/minimum 27 and warnings as
