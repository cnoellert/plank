...
/usr/libexec/PlistBuddy -c 'Set :CFBundleVersion 58' "$app/Contents/Info.plist"
xcrun clang -fobjc-arc -Wall -Wextra -Werror -mmacosx-version-min=27.0 \
    ...
    -framework CoreGraphics -framework QuartzCore -o "$app/Contents/MacOS/plank-host-probe"
