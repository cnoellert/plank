...
case $role in
  linux-host)
    ...
    # Candidate-only qualification of the deferred mouse release regression.
    ...
    (
      ...
      ./tests/test_sunshine --gtest_filter=InputRetainedSessionTest.DisconnectReleasesLeftButtonWithDeferredReleasePending
    )
    ;;
  linux-client)
