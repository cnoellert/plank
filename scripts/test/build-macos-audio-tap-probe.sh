...
xcrun --sdk macosx clang -fobjc-arc -Wall -Wextra -Werror -mmacosx-version-min=27.0 \
    -I"$1/apps/host/macos/media" "$1/probes/macos/audio-tap.m" \
    "$1/probes/macos/session-audio-tap.m" "$1/apps/host/macos/media/audio-tap.m" \
    "$1/apps/host/macos/media/opus-encoder.m" -framework AppKit -framework CoreAudio \
